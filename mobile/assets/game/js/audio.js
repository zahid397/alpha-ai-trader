...
export class Sfx {
  ...
  slam(near) {
    if (!this.#ok('slam', 0.2)) return;
    const g = near ? 1 : 0.4;
    this.tone(62, 0.7, { type: 'sine', gain: 0.5 * g, to: 30 });
    this.noise(0.6, { type: 'lowpass', freq: 900, to: 90, gain: 0.45 * g });
    this.noise(0.25, { type: 'bandpass', freq: 2400, to: 700, q: 0.8, gain: 0.18 * g, at: 0.03 });
  }
